...
@section('subTitle', __('admin.Edit service category'))
@section('content')
<!-- BEGIN: Content-->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('admin.Edit service category')}}</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form method="post" action="{{route('serviceCategories.update', ['id' => $serviceCategory->id])}}">
                                        {!! csrf_field() !!}
                                        @method('patch')
                                        <div class="row">
                                            <div class="col-md-12">
