...
@section('subTitle', __('admin.Add new document'))
@section('content')
<!-- BEGIN: Content-->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('admin.Add new document')}}</h4>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-label-group">
                                                        <input id="menu_ar" style="direction: rtl;" type="text" value="{{old('menu_ar')}}" class="form-control" placeholder="{{__('admin.Arabic Title')}}" name="menu_ar" required>
                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="form-label-group">
                                                        <input id="menu_en" style="direction: ltr;" type="text" value="{{old('menu_en')}}" class="form-control" placeholder="{{__('admin.English Title')}}" name="menu_en" required>
                                                ...
                                                <div class="col-md-4 col-4">
                                                    <div class="form-group">
                                                        ...
                                                        @php ($max=\App\Documentation::max('arr'))
                                                        <input id="arr" type="text" name="arr" placeholder="{{__('admin.arrange')}}" class="select form-control" value="{{old('arr')??$max+1}}">
                                                    </div>
                                                    <br>
                                                </div>
                                                <div class="col-md-4 col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="role" class="select form-control">
                                                            <option value="all" {{old('role') == 'all' ?'selected':''}}>{{__('admin.All')}}</option>
                                                            <option value="user" {{old('role') == 'user' ?'selected':''}}>{{__('admin.Users')}}</option>
                                                            <option value="mentor" {{old('role') == 'mentor' ?'selected':''}}>{{__('admin.Mentors')}}</option>
                                                            <option value="judge" {{old('role') == 'judge' ?'selected':''}}>{{__('admin.Judgers')}}</option>
                                                            <option value="admin" {{old('role') == 'admin' ?'selected':''}}>{{__('admin.Managers')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="icon" class="select2-icons form-control" id="icon">
                                                            ...
                                                            <option value="{{$icon}}"  data-icon="bx {{$icon}}" {{old('icon') == $icon ?'selected':''}}>{{$icon}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
            ...
            file_picker_callback: function(cb, value, meta) {
                ...
                input.onchange = function() {
                    ...
                    reader.onload = function () {
                        ...
                        cb(blobInfo.blobUri(), { title: file.location });
                    };
                };
                input.click();
            }
