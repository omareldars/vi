                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                  	 <form class="form-horizontal form-bordered" id="basicForm" action= "/admin/storeevent" method="post" enctype="multipart/form-data">
               							 {!! csrf_field() !!}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-label-group">
                                                            <input style="direction: rtl;" type="text" class="form-control" placeholder="" name="title_ar" required>
                                                            <label for="title_ar">{{__('settings.ARABICTITLE')}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-label-group">
                                                            <input style="direction: ltr;" type="text" class="form-control" name="title_en" required>
                                                            <label for="title_en">{{__('settings.ENGLISHTITLE')}}</label>
                                                        </div>
                                                    </div>
                                                     <div class="col-md-12 col-12">
                                                        <div class="form-label-group">
                                                            <textarea class="form-control" id="body_ar" rows="8" name="body_ar" required></textarea>
                                                            <label for="ar_body">{{__('settings.Content')}} {{__('settings.InArabic')}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-label-group">
                                                            <textarea class="form-control" id="body_en" rows="8" name="body_en" required></textarea>
													...
													<div class="col-12">&nbsp;</div>
													 <div class="col-md-12 col-12">
                                                        <div class="form-label-group">
                                                            ...
                                                            <input type="text" class="form-control" id="SelectDate" name="timerdate" >
                                                            <label for="timerdate">{{__('settings.EventDT')}}: 2022/01/15 13:30:00</label>
                                                        </div>
                                                    </div>
													 <div class="col-md-12 col-12">
                                                        <div class="form-label-group">
                                                            <textarea style="direction: ltr;" class="form-control" id="googlemap" rows="3" name="googlemap" ></textarea>
													...
													<div class="custom-control custom-switch custom-control-inline mb-1">
                                            			...
                                            			<input name="showtimer" type="checkbox" class="custom-control-input" id="customSwitch1">
													...
													<div class="custom-control custom-switch custom-control-inline mb-1">
                                            			...
                                            			<input name="published" type="checkbox" class="custom-control-input" id="customSwitch3">
