...
@stop
@section('title', __('cycles.Final Screening') )
@section('subTitle', __('cycles.Submit your opinion'))
@section('content')
    <!-- BEGIN: Content-->
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            @endif
                                                ...
                                                <br>
                                                <h5 class="primary">{{__('cycles.answer submit')}}:</h5>
                                                <br>
                                        <form method="post" action="/admin/final/save" enctype="multipart/form-data">
                                            {!! csrf_field() !!}
                                            <div class="row">
                                                <div class="col-md-12">
