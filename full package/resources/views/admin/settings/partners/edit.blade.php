...
@section('index_url', route('partners.index') )
@section('subTitle', __('admin.Edit Partner'))
@section('content')
<!-- BEGIN: Content-->
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('admin.Edit Partner')}}</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form method="post" action="{{route('partners.update', ['id' => $partner->id])}}"
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                <img style='width: 100%;' class="img-responsive pad" src="/191014/{{ $partner->img_url }}" alt="{{ $partner->name_en }}">
                                </div>
                            </div>
                        </div>
                    </div>
