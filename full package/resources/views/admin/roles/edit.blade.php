...
@section('index_url', route('roles.index') )
@section('subTitle', __('admin.EditRole'))
@section('content')
<!-- BEGIN: Content-->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('admin.EditPermission')}}</h4>
                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name='name'
                                                        required placeholder="{{__('admin.Title')}}" style="direction: ltr;"
                                                        value="{{ $role->name }}" >
                                                </fieldset>
